				...
				If[KantorovichQ,
					If[residual<=TOL||NewtonQ,
						...
						,
							errorestimator=infty;
							linesearchQ=ArmijoC>0;
							(*There is no way to reduce the residual below machine epsilon. If the algorithm reaches here, the problem is probably \.00too ill-conditioned to be solved in machine precision.*)
